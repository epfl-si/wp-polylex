...
module.exports.deleteAllDocuments = async function (
  ...
  if (collectionToDelete === "all") {
    await db.collection("lexes").deleteMany({});
    console.log(`All documents off lexes collections are deleted`);

    await db.collection("responsibles").deleteMany({});
    console.log(`All documents off responsibles collections are deleted`);

    await db.collection("roles").deleteMany({});
    console.log(`All documents off roles collections are deleted`);

    await db.collection("categories").deleteMany({});
    console.log(`All documents off categories collections are deleted`);

    await db.collection("subcategories").deleteMany({});
    console.log(`All documents off subcategories collections are deleted`);
