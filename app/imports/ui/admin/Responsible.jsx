                ...
                <span
                  onClick={() => {
                    if (
                      ...
                      this.props.callBackDeleteResponsible(responsible._id);
                  }}
                  aria-hidden="true"
                >
                  &times;
...
class Responsible extends Component {
  ...
  deleteResponsible = (responsibleId) => {
    removeResponsible.call({responsibleId}, (error, responsibleId) => {
      if (error) {
  ...
  submitResponsible = (values, actions) => {
    if (this.state.action === "add") {
      insertResponsible.call(values, (errors, ResponsibleId) => {
        if (errors) {
          console.log(errors);
          let formErrors = {};
      ...
      updateResponsible.call(values, (errors, ResponsibleId) => {
        if (errors) {
          console.log(errors);
          let formErrors = {};
          errors.details.forEach(function (error) {
  ...
  render() {
    ...
    let isLoading =
      this.props.responsibles == undefined || initialValues == undefined;
        ...
        <Fragment>
          ...
          {isDisplayResponsibleList ? (
            ...
            <h5 className="card-header">
              Édition du responsable des Lexes suivant:{" "}
            </h5>
          )}
