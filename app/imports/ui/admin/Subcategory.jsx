...
class SubcategoriesList extends Component {
  render() { 
    return (
      <Fragment>
        <h5 className="card-header">Liste des sous-catégories</h5>    
      ...
      content = (
        <Fragment>
          ...
          { isDisplaySubcategoriesList ? (
            ...
            />
          ):(<h5 className="card-header">Édition de la sous-catégorie des Lexes suivante: </h5>)}
          <div className="card-body">

            { this.state.addSuccess ? ( 
              <AlertSuccess message={ 'La nouvelle sous-catégorie a été ajoutée avec succès !' } />
            ) : (null) }
                ...
                {({
                  ...
                  <form onSubmit={ handleSubmit }>
                    <Field 
                      ...
                      placeholder="Nom de la sous catégorie en français à ajouter" name="nameFr" type="text" component={ CustomInput } />
                    <ErrorMessage name="nameFr" component={ CustomError } />
                    
                    <Field 
                      onChange={e => { handleChange(e); this.updateUserMsg();}}
                      onBlur={e => { handleBlur(e); this.updateUserMsg();}}
                      placeholder="Nom de la sous catégorie en anglais à ajouter" name="nameEn" type="text" component={ CustomInput } />
